 ...
 */
@InternalApi private[fory] trait ActorRefModule extends JacksonModule {
 ...
 * INTERNAL API
 */
@InternalApi private[fory] object ActorRefSerializer {
 ...
 * INTERNAL API
 */
@InternalApi private[fory] class ActorRefSerializer
 ...
 * INTERNAL API
 */
@InternalApi private[fory] object ActorRefDeserializer {
 ...
 * INTERNAL API
 */
@InternalApi private[fory] class ActorRefDeserializer
