 ...
 */
@InternalApi private[fory] trait AddressModule extends JacksonModule {
 ...
 * INTERNAL API
 */
@InternalApi private[fory] object AddressSerializer {
 ...
 * INTERNAL API
 */
@InternalApi private[fory] class AddressSerializer extends StdScalarSerializer[Address](classOf[Address]) {
 ...
 * INTERNAL API
 */
@InternalApi private[fory] object AddressDeserializer {
 ...
 * INTERNAL API
 */
@InternalApi private[fory] class AddressDeserializer extends StdScalarDeserializer[Address](classOf[Address]) {
