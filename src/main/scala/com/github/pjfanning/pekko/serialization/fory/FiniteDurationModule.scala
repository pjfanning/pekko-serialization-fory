 ...
 */
@InternalApi private[fory] trait FiniteDurationModule extends JacksonModule {
  addSerializer(
 ...
 * INTERNAL API
 */
@InternalApi private[fory] object FiniteDurationSerializer {
 ...
 */
@InternalApi private[fory] class FiniteDurationSerializer
 ...
 * INTERNAL API
 */
@InternalApi private[fory] object FiniteDurationDeserializer {
 ...
 */
@InternalApi private[fory] class FiniteDurationDeserializer
