 ...
 * INTERNAL API
 */
@InternalApi private[fory] object JacksonModule {

  lazy val version: Version = {
    val groupId = "org.apache.pekko"
    val artifactId = "serialization-fory"
 ...
 * INTERNAL API
 */
@InternalApi private[fory] object VersionExtractor {
 ...
 * INTERNAL API
 */
@InternalApi private[fory] trait JacksonModule extends Module {
