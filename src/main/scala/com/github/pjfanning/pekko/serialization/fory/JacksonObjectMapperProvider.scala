...
object JacksonObjectMapperProvider extends ExtensionId[JacksonObjectMapperProvider] with ExtensionIdProvider {
  ...
  def configForBinding(bindingName: String, systemConfig: Config): Config = {
    val basePath = "pekko.serialization.fory"
            ...
            case Failure(e) =>
              log.foreach(
                _.error(
                  ...
                  "[pekko.serialization.fory.jackson-modules]. Continuing without this module."))
              None
          }
        } else
          None
  ...
  private def isModuleEnabled(fqcn: String, dynamicAccess: DynamicAccess): Boolean =
    fqcn match {
      case "com.github.pjfanning.pekko.serialization.fory.PekkoTypedJacksonModule" =>
      ...
      case "com.github.pjfanning.pekko.serialization.fory.PekkoStreamJacksonModule" =>
...
final class JacksonObjectMapperProvider(system: ExtendedActorSystem) extends Extension {
   ...
   * in `pekko.serialization.fory.jackson-modules`. It's using [[JacksonObjectMapperProviderSetup]]
...
class JacksonObjectMapperFactory {
   ...
   *                           `pekko.serialization.fory.deserialization-features`
   */
   ...
   *
   * @param bindingName bindingName name of this `ObjectMapper`
   * @param configuredFeatures the list of `MapperFeatures` that were configured in `pekko.serialization.fory.mapper-features`
   */
   ...
   *
   * @param bindingName bindingName name of this `ObjectMapper`
   * @param configuredFeatures the list of `JsonParser.Feature` that were configured in `pekko.serialization.fory.json-parser-features`
   */
   ...
   *
   * @param bindingName bindingName name of this `ObjectMapper`
   * @param configuredFeatures the list of `JsonGenerator.Feature` that were configured in `pekko.serialization.fory.json-generator-features`
   */
   ...
   *
   * @param bindingName bindingName name of this `ObjectMapper`
   * @param configuredFeatures the list of `StreamReadFeature` that were configured in `pekko.serialization.fory.stream-read-features`
   */
   ...
   *
   * @param bindingName bindingName name of this `ObjectMapper`
   * @param configuredFeatures the list of `StreamWriterFeature` that were configured in `pekko.serialization.fory.stream-write-features`
   */
   ...
   *
   * @param bindingName bindingName name of this `ObjectMapper`
   * @param configuredFeatures the list of `JsonReadFeature` that were configured in `pekko.serialization.fory.json-read-features`
   */
   ...
   *
   * @param bindingName bindingName name of this `ObjectMapper`
   * @param configuredFeatures the list of `JsonWriteFeature` that were configured in `pekko.serialization.fory.json-write-features`
   */
