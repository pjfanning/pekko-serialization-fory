...
// FIXME maybe move many things to `com.github.pjfanning.pekko.serialization.fory.internal` package?
 ...
 */
@InternalApi private[fory] trait StreamRefModule extends JacksonModule {
 ...
 * INTERNAL API
 */
@InternalApi private[fory] object SourceRefSerializer {
 ...
 * INTERNAL API
 */
@InternalApi private[fory] class SourceRefSerializer
 ...
 * INTERNAL API
 */
@InternalApi private[fory] object SourceRefDeserializer {
 ...
 * INTERNAL API
 */
@InternalApi private[fory] class SourceRefDeserializer
 ...
 * INTERNAL API
 */
@InternalApi private[fory] object SinkRefSerializer {
 ...
 * INTERNAL API
 */
@InternalApi private[fory] class SinkRefSerializer
 ...
 * INTERNAL API
 */
@InternalApi private[fory] object SinkRefDeserializer {
 ...
 * INTERNAL API
 */
@InternalApi private[fory] class SinkRefDeserializer
