 ...
 */
@InternalApi private[fory] trait TypedActorRefModule extends JacksonModule {
 ...
 * INTERNAL API
 */
@InternalApi private[fory] object TypedActorRefSerializer {
 ...
 * INTERNAL API
 */
@InternalApi private[fory] class TypedActorRefSerializer
 ...
 * INTERNAL API
 */
@InternalApi private[fory] object TypedActorRefDeserializer {
 ...
 * INTERNAL API
 */
@InternalApi private[fory] class TypedActorRefDeserializer
