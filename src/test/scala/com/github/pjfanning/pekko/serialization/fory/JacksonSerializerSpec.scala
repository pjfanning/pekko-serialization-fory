...
class JacksonJsonSerializerSpec extends JacksonSerializerSpec("jackson-json") {
  ...
  "JacksonJsonSerializer" must {
    ...
    "JacksonSerializer configuration" must {
      ...
      withSystem("""
        pekko.actor.serializers.jackson-json2 = "com.github.pjfanning.pekko.serialization.fory.JacksonJsonSerializer"
        pekko.actor.serialization-identifiers.jackson-json2 = 999
        pekko.serialization.fory.jackson-json2 {
  ...
  "JacksonJsonSerializer with Java message classes" must {
    ...
    "be possible to serialize dates and durations as numeric timestamps" in {
      withSystem("""
        pekko.serialization.fory.serialization-features {
      ...
      withSystem("""
        pekko.actor {
          serialization-bindings {
            "com.github.pjfanning.pekko.serialization.fory.JavaTestMessages$ClassWithVisibility" = jackson-json
          }
        }
        pekko.serialization.fory.visibility {
          FIELD = PUBLIC_ONLY
        }
        """) { sys =>
  ...
  "JacksonJsonSerializer with Scala message classes" must {
    ...
    "compress large payload with lz4" in withSystem("""
        pekko.serialization.fory.jackson-json.compression {
          algorithm = lz4
  ...
  "JacksonJsonSerializer without type in manifest" should {
    ...
    "deserialize messages using the serialization bindings" in withSystem(
      """
        pekko.actor {
          serializers.animal = "com.github.pjfanning.pekko.serialization.fory.JacksonJsonSerializer"
          serialization-identifiers.animal = 9091
          serialization-bindings {
            "com.github.pjfanning.pekko.serialization.fory.ScalaTestMessages$Animal" = animal
          }
        }
        pekko.serialization.fory.animal.type-in-manifest = off
        """) { sys =>
    ...
    "deserialize messages using the configured deserialization type" in withSystem(
      """
        pekko.actor {
          ...
          serialization-identifiers.animal = 9091
          serialization-bindings {
            "com.github.pjfanning.pekko.serialization.fory.ScalaTestMessages$Elephant" = animal
            "com.github.pjfanning.pekko.serialization.fory.ScalaTestMessages$Lion" = animal
          }
        }
        pekko.serialization.fory.animal {
          type-in-manifest = off
          deserialization-type = "com.github.pjfanning.pekko.serialization.fory.ScalaTestMessages$Animal"
        }
      """) { sys =>
      val msg = Elephant("Dumbo", 1)
      val serializer = serializerFor(msg, sys)
...
object JacksonSerializerSpec {
  def baseConfig(serializerName: String): String = s"""
    pekko.actor {
      serialization-bindings {
        "com.github.pjfanning.pekko.serialization.fory.ScalaTestMessages$$TestMessage" = $serializerName
        "com.github.pjfanning.pekko.serialization.fory.JavaTestMessages$$TestMessage" = $serializerName
      }
    }
    pekko.serialization.fory.allowed-class-prefix = ["com.github.pjfanning.pekko.serialization.fory.ScalaTestMessages$$OldCommand"]

    pekko.actor {
      serializers {
          inner-serializer = "com.github.pjfanning.pekko.serialization.fory.ScalaTestMessages$$InnerSerializationSerializer"
      }
      serialization-bindings {
        "com.github.pjfanning.pekko.serialization.fory.ScalaTestMessages$$HasPekkoSerializer" = "inner-serializer"
      }
    }
    """
}
  ...
  "JacksonSerializer with Java message classes" must {
    ...
    "deserialize with migrations" in withSystem(s"""
        pekko.serialization.fory.migrations {
          ...
          "deserialize-Java.Event1-into-Java.Event3" = "com.github.pjfanning.pekko.serialization.fory.JavaTestEventMigrationV3"
        }
    ...
    "deserialize with migrations from V2" in {
      ...
      withSystem(s"""
        pekko.serialization.fory.migrations {
          "com.github.pjfanning.pekko.serialization.fory.JavaTestMessages$$Event1" = "com.github.pjfanning.pekko.serialization.fory.JavaTestEventMigrationV2"
          "com.github.pjfanning.pekko.serialization.fory.JavaTestMessages$$Event2" = "com.github.pjfanning.pekko.serialization.fory.JavaTestEventMigrationV2"
        }
    ...
    "use the migration's currentVersion on new serializations when supporting forward versions" in {
      withSystem(s"""
        pekko.serialization.fory.migrations {
          "com.github.pjfanning.pekko.serialization.fory.JavaTestMessages$$Event2" = "com.github.pjfanning.pekko.serialization.fory.JavaTestEventMigrationV2WithV3"
        }
        """ + JacksonSerializerSpec.baseConfig(serializerName)) { sysV2 =>
        val event2 = new Event2("a", 17)
        // Event2 has a migration configured so it uses a manifest with a version
    ...
    "deserialize a V3 blob into a V2 class (forward-one support) and back" in {
      ...
      val blobV3 =
        withSystem(s"""
        pekko.serialization.fory.migrations {
          "com.github.pjfanning.pekko.serialization.fory.JavaTestMessages$$Event3" = "com.github.pjfanning.pekko.serialization.fory.JavaTestEventMigrationV3"
        }
  ...
  "JacksonSerializer with Scala message classes" must {
    ...
    "deserialize with migrations" in withSystem(s"""
        pekko.serialization.fory.migrations {
          ## Usually the key is a FQCN but we're hacking the name to use multiple migrations for the
          ## same type in a single test.
          "deserialize-Event1-into-Event3" = "com.github.pjfanning.pekko.serialization.fory.ScalaTestEventMigrationV3"
        }
        """ + JacksonSerializerSpec.baseConfig(serializerName)) { sys =>
      val event1 = Event1("a")
      val serializer = serializerFor(event1, sys)
    ...
    "deserialize with migrations from V2" in {
      ...
      withSystem(s"""
        pekko.serialization.fory.migrations {
          "com.github.pjfanning.pekko.serialization.fory.ScalaTestMessages$$Event1" = "com.github.pjfanning.pekko.serialization.fory.ScalaTestEventMigrationV2"
          "com.github.pjfanning.pekko.serialization.fory.ScalaTestMessages$$Event2" = "com.github.pjfanning.pekko.serialization.fory.ScalaTestEventMigrationV2"
        }
        """ + JacksonSerializerSpec.baseConfig(serializerName)) { sysV2 =>
        // read the blob/manifest from an ActorSystem with migrations
        val serializerV2: JacksonSerializer = serializerFor(event1, sysV2)
    ...
    "deserialize a V3 blob into a V2 class (forward-one support) and back" in {
      ...
      val blobV3 =
        withSystem(s"""
        pekko.serialization.fory.migrations {
          "com.github.pjfanning.pekko.serialization.fory.ScalaTestMessages$$Event3" = "com.github.pjfanning.pekko.serialization.fory.ScalaTestEventMigrationV3"
        }
        """ + JacksonSerializerSpec.baseConfig(serializerName)) { sysV3 =>
          val event3 = new Event3("Steve", 49)
          val serializer = serializerFor(event3, sysV3)
      ...
      val blobV2 =
        withSystem(s"""
        pekko.serialization.fory.migrations {
          "com.github.pjfanning.pekko.serialization.fory.ScalaTestMessages$$Event2" = "com.github.pjfanning.pekko.serialization.fory.ScalaTestEventMigrationV2WithV3"
        }
        """ + JacksonSerializerSpec.baseConfig(serializerName)) { sysV2WithV3 =>
          val serializerForEvent2 =
            serialization(sysV2WithV3).serializerFor(classOf[Event2]).asInstanceOf[JacksonSerializer]
