...
object SerializationDocJacksonSpec {
  ...
  val configSpecific = """
    ...
    pekko.serialization.fory.jackson-cbor {
      serialization-features {
  ...
  val configSeveral = """
    ...
    pekko.actor {
      serializers {
        jackson-json-message = "com.github.pjfanning.pekko.serialization.fory.JacksonJsonSerializer"
        jackson-json-event   = "com.github.pjfanning.pekko.serialization.fory.JacksonJsonSerializer"
      }
  ...
  val configAllowList = """
    ...
    pekko.serialization.fory.allowed-class-prefix =
...
class SerializationDocJacksonSpec
  ...
  "EventMigration doc sample Java classes" must {
    ...
    "test add mandatory field" in {
      ...
      val event2 = serializer
        .fromBinary(blob, classOf[jdoc.org.apache.pekko.serialization.fory.v2b.ItemAdded].getName)
        .asInstanceOf[jdoc.org.apache.pekko.serialization.fory.v2b.ItemAdded]
      event2.quantity should ===(event1.quantity)
  ...
  "EventMigration doc sample Scala classes" must {
    ...
    "test add mandatory field" in {
      ...
      val blob = serializer.toBinary(event1)
      val event2 = serializer
        .fromBinary(blob, classOf[doc.org.apache.pekko.serialization.fory.v2b.ItemAdded].getName)
        .asInstanceOf[doc.org.apache.pekko.serialization.fory.v2b.ItemAdded]
      event2.quantity should ===(event1.quantity)
      event2.discount should be(0.0 +- 0.000001)
